...
function Profile() {
    ...
    console.log(' loc strogae at profile pg ',user)
    ...
    const handleClick = async () => {
        try {
            ...
            console.log('new value loc store',JSON.parse(localStorage.getItem("user")).data)
        } catch (error) {
            console.log(error);
        }
    }
            ...
            <div className="form-container">
                <div className='h1Box'>
                    ...
                    <div className="profileImage">
                        {/*<img src="F:/backend_practise_march_22/foodApp/Images/UserIcon.png" />*/} 
                    </div>
                </div>
